...
> **Research review:** 2026-09-13. Checked against current Kubernetes 1.36 documentation, NVIDIA GPU Operator platform support, KServe 0.16 LLMInferenceService requirements, and current vLLM Kubernetes deployment guidance.
...
KServe 0.16 documents Kubernetes `1.32+` as the minimum for its `LLMInferenceService`, which means Kubernetes 1.36 is comfortably above that requirement.
...
- KServe LLMInferenceService Kubernetes deployment requirements: <https://kserve.github.io/website/docs/0.16/admin-guide/kubernetes-deployment-llmisvc>
