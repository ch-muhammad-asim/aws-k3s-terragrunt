...
For a Linux-distribution-agnostic Terraform/Terragrunt project like this repository, K3s remains a cleaner default because it does not make Snap part of the platform operating model.
