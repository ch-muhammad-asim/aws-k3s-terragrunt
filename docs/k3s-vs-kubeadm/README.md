...
This repository already uses a distribution-agnostic Linux/EC2 operating model. K3s fits that model naturally without making snap lifecycle management a platform dependency.
...
- What is Talos Linux: https://docs.siderolabs.com/talos/v1.12/overview/what-is-talos
- Production clusters: https://docs.siderolabs.com/talos/v1.12/getting-started/production-clusters
